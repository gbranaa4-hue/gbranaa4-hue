...
question: **when does structure/symmetry actually *help* computation?** And two
games that put the neuromorphic side to work. Real measurements, stated limits,
positive *and* negative results both on the record.
